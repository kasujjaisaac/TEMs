...
<head>
    ...
    <style>
        :root{--onyx-bg:#07111a;--onyx-surface:#101923;--onyx-surface-2:#131d28;--onyx-accent:#ffffff;--onyx-accent-2:#d8d8de;--onyx-border:#263241;--onyx-text:#f5f7fa;--onyx-muted:#8d99a8}
        ...
        .onyx-erp-body{background:linear-gradient(rgba(255,255,255,.026) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.018) 1px,transparent 1px),radial-gradient(circle at 82% 0,rgba(255,255,255,.13),transparent 30%),linear-gradient(180deg,#07111a 0%,#050a10 100%)!important;background-size:42px 42px,42px 42px,auto,auto!important}.onyx-erp-body .sidebar{background:linear-gradient(180deg,rgba(255,255,255,.075),transparent 22%),linear-gradient(180deg,#07111a 0%,#050a10 100%)!important;border-right-color:rgba(255,255,255,.2)!important}.main-topbar{background:linear-gradient(90deg,rgba(255,255,255,.13),transparent 32%),#07111a!important;border-bottom-color:rgba(255,255,255,.22)!important}.sidebar-logo-plate,.topbar-brand img,.topbar-user-avatar,.sidebar-user-avatar,.topbar-sidebar-toggle{background:var(--onyx-accent)!important;border-color:var(--onyx-accent)!important;color:#050506!important}.nav-dropdown-toggle.active,.nav-dropdown-toggle:hover,.nav-link-onyx:hover,.nav-link-onyx.active{background:rgba(255,255,255,.1)!important;border-left-color:var(--onyx-accent)!important;color:#fff!important}.nav-link-onyx.active i,.nav-dropdown-toggle.active i,.nav-dropdown-toggle:hover i,.nav-link-onyx:hover i{color:var(--onyx-accent)!important}.topbar-search,.topbar-action,.topbar-icon,.topbar-chip,.topbar-user,.logout-btn{background:rgba(16,25,35,.82)!important;border-color:rgba(255,255,255,.18)!important}.panel,.onyx-erp-body .stat-card,.ops-card,.ops-action,.ops-check,.ops-report-card{background:linear-gradient(180deg,rgba(255,255,255,.035),rgba(255,255,255,.012)),var(--onyx-surface)!important;border-color:rgba(255,255,255,.18)!important;box-shadow:0 10px 28px rgba(0,0,0,.24)!important}.ops-btn,.ops-action.primary,.action-btn:hover{background:var(--onyx-accent)!important;border-color:var(--onyx-accent)!important;color:#050506!important}.ops-btn.ghost,.ops-action,.action-btn{background:rgba(255,255,255,.025)!important;border-color:rgba(255,255,255,.2)!important;color:#f5f7fa!important}.ops-field input,.ops-field select,.ops-field textarea,.ops-filters input,.ops-filters select{background:#0b141e!important;border-color:rgba(255,255,255,.18)!important;color:#fff!important}.ops-field input:focus,.ops-field select:focus,.ops-field textarea:focus{border-color:var(--onyx-accent)!important;box-shadow:0 0 0 3px rgba(255,255,255,.13)!important;outline:0}.onyx-erp-body .table tbody tr:hover{background:rgba(255,255,255,.055)!important}.accent-text,.action-btn i,.panel-title i,.currency-badge,.badge,.topbar-chip i,.topbar-action i{color:var(--onyx-accent)!important}@media(max-width:1180px){.stat-grid{grid-template-columns:repeat(2,minmax(150px,1fr))}.span-3,.span-4,.span-5,.span-6,.span-7,.span-8{grid-column:span 12}.main-topbar{align-items:stretch;flex-direction:column}.topbar-left,.topbar-right{width:100%}.topbar-brand{flex-basis:auto;width:100%}.topbar-search{width:100%}}@media(max-width:760px){.onyx-erp-body .sidebar{height:auto;position:static;width:100%}.main-content{margin-left:0;padding:20px}.main-topbar{margin:-20px -20px 24px;width:calc(100% + 40px)}.page-header{flex-direction:column}.stat-grid{grid-template-columns:1fr}.topbar-right{justify-content:flex-start}}
    </style>
</head>
